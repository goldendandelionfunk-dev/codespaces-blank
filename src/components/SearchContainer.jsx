...
const SearchContainer = memo(function SearchContainer({ logo = true, cls, nav = true, navigating }) {
  ...
  const placeholder = useMemo(
    () => `Search anonymously with ${options.engineName || 'DuckDuckGo'} or type URL`,
    [options.engineName],
  );
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-gray-400">
        Anonub enables private, anonymous browsing and optional cloaking of the
        site title/icon to mimic another service.
      </p>
