...
app.get("/assets/img/*", proxy(req => `https://anonub-assets.pages.dev/img/${req.params["*"]}`, ""));
app.get("/assets-fb/*", proxy(req => `https://anonub-assets.pages.dev/img/server/${req.params["*"]}`, ""));
